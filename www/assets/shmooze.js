(function(exports){
    ...
    exports.pool_endpoint = new Endpoint(BASE_URL + "/pool");
    exports.nlp_endpoint = new Endpoint(BASE_URL + "/nlp");

    exports.endpoints = {};

    exports.regainConnection = pool_endpoint.onAlive = function(){
        $(".disconnect-hide").show();
        $(".disconnect-show").hide();
    }

    exports.lostConnection = pool_endpoint.onDead = function (){
